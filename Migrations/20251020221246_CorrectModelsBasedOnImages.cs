...
{
    /// <inheritdoc />
    public partial class CorrectModelsBasedOnImages : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TypeVehicle = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    HourPrice = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
                    AddPrice = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
                    MaxPrice = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
                    GraceTime = table.Column<int>(type: "integer", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialCash = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
                    FinalCash = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
                    TotalCashPayments = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
                    TotalCardPayments = table.Column<decimal>(type: "numeric(10,2)", nullable: true)
                },
                constraints: table =>
                {
